...
Motor leftMotor(INVERSE, A0, 6, 7, 2, 4); // Motor 1: pwm = a0, in1=6, in2=7, encA=2, encB=4
Motor rightMotor(DIRECT, A1, 8, 9, 3, 5); // Motor 2: pwm = a1, in1=8, in2=9, encA=3, encB=5
